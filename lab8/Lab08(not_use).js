...
let sizePerImg=600;
let formerImgBt=document.getElementById("bd").getElementsByClassName("arrow_left")[0];
let latterImgBt=document.getElementById("bd").getElementsByClassName("arrow_right")[0];
let pageBts=document.getElementById("bd").getElementsByClassName("buttons")[0].getElementsByTagName("span");
let pageNumbers=pageBts.length;
let shouldContinue=true;
let container=document.getElementsByClassName("container")[0];
let editableTdElements=document.getElementById("bd").getElementsByTagName("table")[0].getElementsByTagName("td");
const shiftToPage=(function()
{
	let imgWheel=document.getElementById("bd").getElementsByClassName("wrap")[0];
	//let pageBts=document.getElementById("bd").getElementsByClassName("buttons")[0].getElementsByTagName("span");
	return function (index)
	{
		...
		let left=-index*sizePerImg;
		imgWheel.style.left=left+"px";
	}
})();
/*********************************************end*************************************/
...
formerImgBt.onclick=function ()
{
	...
	if (targetPageIndex===0)
		targetPageIndex+=pageNumbers;
	shiftToPage(targetPageIndex);
};
latterImgBt.onclick=function ()
{
	let targetPageIndex=currentPageIndex+1;
	if (targetPageIndex>pageNumbers)
		targetPageIndex=1;
	shiftToPage(targetPageIndex);
};
...
for (let i = 0; i < editableTdElements.length; i++)
{
	...
	{
		this.style.backgroundColor="#fffcdd";
	};
