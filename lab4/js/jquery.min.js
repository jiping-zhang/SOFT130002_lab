...
}("undefined" != typeof window ? window : this, function (a, b)
{
	var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString, j = h.hasOwnProperty,
		k = {}, l = a.document, m = "2.1.4", n = function (a, b) {return new n.fn.init(a, b)},
	...
	var t = function (a)
	{
		var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + 1 * new Date, v = a.document, w = 0,
			x = 0, y = ha(), z = ha(), A = ha(), B = function (a, b) {return a === b && (l = !0), 0}, C = 1 << 31,
		...
		try
		{H.apply(E = I.call(v.childNodes), v.childNodes), E[v.childNodes.length].nodeType} catch (fa)
		{
			H = {
	...
	K.uid = 1, K.accepts = n.acceptData, K.prototype = {
		key: function (a)
		{
			...
			if (!c)
			{
				c = K.uid++;
				try
				{b[this.expando] = {value: c}, Object.defineProperties(a, b)} catch (d)
	...
	function P(a, b, c)
	{
		...
		{
			try
			{c = "true" === c ? !0 : "false" === c ? !1 : "null" === c ? null : +c + "" === c ? +c : N.test(c) ? n.parseJSON(c) : c} catch (e)
			{}
			M.set(a, b, c)
		}
		else c = void 0;
	...
	n.parseJSON = function (a) {return JSON.parse(a + "")}, n.parseXML = function (a)
	{
		...
		try
		{c = new DOMParser, b = c.parseFromString(a, "text/xml")} catch (d)
		{b = void 0}
